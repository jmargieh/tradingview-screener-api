...
/**
 * Wrapper for a field with a specific time interval
 */
export class FieldWithInterval extends BaseField {
  ...
  /**
   * Get the field name with interval suffix
   */
  override get fieldName(): string {
    return `${this.baseField.fieldName}|${this.interval}`;
  }
  ...
  override toString(): string {
    return `${this.baseField.name}[${this.interval}]`;
  }
}
